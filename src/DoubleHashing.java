...
//            int probeIndex = (index + i * stepSize) % size; // Double hashing probing
...
//        sb.append("DoubleHashing HashTable:\n");
...
//        return Math.abs(key.hashCode()) % size; // Primary hash function
//    }
//
//    private int secondaryHash(String key) {
//        // Secondary hash function (must be non-zero to avoid infinite loops)
//        // This is often chosen to be a prime number less than the size
